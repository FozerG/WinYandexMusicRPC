...
1. Скачиваем [последний доступный релиз](https://github.com/eggdll/WinYandexMusicRPC/releases)
...
Чтобы собрать в 1 exe файл установите pyinstaller, и выполните данную команду:
...
Если вы нашли ошибку, то не стесняйтесь сообщать о ней в [Issues](https://github.com/eggdll/WinYandexMusicRPC/issues)

## TODO
Сделать чтобы таймер не сбрасывался при паузе трека ✅  
Если долгая пауза - убирать статус ✅     
Улучшить поиск песен ✅    
Вместо консоли сделать приложение в трее ✅ (библиотека ест много оперативы 😔)
