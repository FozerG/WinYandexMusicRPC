...
def GetLastVersion(repoUrl):
    try:
        ...
        if current_version != latest_version:
            print(f"[WinYandexMusicRPC] -> A new version has been released on GitHub. You are using - {current_version}. A new version - {latest_version}, you can download it at {repoUrl + '/releases/latest/' + latest_version}")
        else:
